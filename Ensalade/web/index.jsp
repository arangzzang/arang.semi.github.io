    ...
    <section class="swiper-container">
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                ...
                <div class="swiper-wrap" id="customSection"><img src="image/main/이미지1.jpg" alt="" width=100%>
                    ...
                    <div class="innerText">
                        ...
                        <div class="btn_box" id="btn_box">
                            <p><a class="btn" href="#"><span>커스텀보러가기</span></a></p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="swiper-slide">
                <!--swiper-wrap : 이미지와 텍스트를 감싸는 div-->
                <div class="swiper-wrap" id="productSection"><img src="image/main/이미지2.jpg" alt="" width=100%>
                    <!--innerText : 텍스트와 버튼을 감싸는 div -->
                    <div class="innerText">
                        <!-- introText : 소개글 div -->
                        ...
                        <!-- btn_box : 버튼박스div -->
                        <div class="btn_box" id="btn_box">
                            <p><a class="btn" href="#"><span>샐러드보러가기</span></a></p>
                        </div>
                    </div>
                </div>
            ...
            <div class="swiper-slide">
                <div class="swiper-wrap" id="eventSection"><img src="image/main/이미지3.jpg" alt="" width=100%>
                    <!--innerText : 텍스트와 버튼을 감싸는 div -->
                    <div class="innerText">
                        <!-- introText : 소개글 div -->
                        <div class="introText" id="customIntro">
                        ...
                        <!-- btn_box : 버튼박스div -->
                        <div class="btn_box" id="btn_box">
                            <p><a class="btn" href="#"><span>이벤트보러가기</span></a></p>
                        </div>
                    </div>
                </div>
            </div>
		...
		<footer class="footer swiper-slide">
                <div class="footer_wrap">
                    <h2 class="footer_logo"><br>Ensalade</h2>
