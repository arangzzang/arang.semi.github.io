...
.mamager-answer_label>label {font-weight: 700;    font-size: 20px;    padding: 0 55px 0 55px;    margin-top: -9px;    float: left;}
...
.form-control_input_btn {	height: 25px;	width: 115px;	height: 40px;	box-sizing: border-box;	border-radius: 4px;	font-size: 14px;	font-weight: 400;	cursor: pointer;	border-style: none;	font-weight: inherit;	background: #27b06e;	color: #ffffff;}
...
section {	padding-top: 150px;	height: auto;}
section#inquiry-container {	position: relative;	height: 100%;width: 600px;margin: 0 auto;text-align: center;}
</style>
