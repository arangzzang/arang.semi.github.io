				...
				<div class="ebox_textbox">
					...
					<div class="select-input content_row">
						...
						<select id="category" name="category" class="form-control" required>
							...
							<option value="카테고리[비건]">카테고리[비건]</option>
							<option value="카테고리[육류]">카테고리[육류]</option>
							<option value="카테고리[해산물]">카테고리[해산물]</option>
							<option value="카테고리[유제품]">카테고리[유제품]</option>
					...
					<div class="e_titlebox content_row">
						<input type="text" id="eName" name="eName" class="form-control content-left content-right" placeholder="제목 입력" required>
						<span>종료날짜</span>
						<input type="date" id="endDate" name="endDate" class="form-control content-left content-right" required>
						<input type="number" id="sale" name="sale" class="form-control content-left content-right" placeholder="할인율을 입력하세요. 기본값 0" required>
					</div>
					<!-- 작성 div -->
					<div class="e_imgbox content_row">
						내용이미지추가<input type="file" name="content_file">
					</div>
				</div>
			</div>
			<!-- 글올리기 버튼 -->
			<div class="btn-wrap">
				<input type="submit" id="writeup" class="form-control_input_btn" value="글 등록" >
			</div>
		</div>		
	</form>
</section>
