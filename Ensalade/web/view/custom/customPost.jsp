		...
		<div id="search-container">
			<div class="searchtype_ box_ type_">
				<select id="searchType">
					<option id="123" value="member_id"
						<%=type != null && type.equals("member_id") ? "selected" : ""%>><label>글쓴이</label></option>
					<option value="title"
						<%=type != null && type.equals("title") ? "selected" : ""%>><label>글제목</label></option>
					<option value="content"
						<%=type != null && type.equals("content") ? "selected" : ""%>><label>글내용</label></option>
				</select>
				<div id="search-type">
					<input type="hidden" name="searchType" id="searchType2"
						value="member_id"> <input type="text" name="searchKeyword"
						id="search3" placeholder="아이디 검색" size="25" class="pad"> <input
						type="button" value="검색" id="btn" class="btn_1"
						style="width: 77.68px, height:42.7px">
				</div>
				<!-- 글작성 버튼 -->
				<div id="write-container">
					<button class="btn_1" onclick=location.replace(
						"<%=request.getContextPath()%>/custom/customWrite
						<%=loginMember != null ? "?userId=" + loginMember.getMemberId() : ""%>")>글작성</button>
				</div>
			</div>
		</div>
	...
	<div id="custom_post" class="post">
		...
		<div class="post_c">
			<div style="display: inline-flex">
				<span><svg class="a1 a2" aria-hidden="true" focusable="false"
						data-prefix="far" data-icon="user"
				...
				<p class="id_1"><%=p.getMemberId()%></p>
			</div>
			<div class="img1">
				<span><label class='view'>조회수 <%=p.getViewCount()%></label></span>
			</div>
			<div class="aside">
				<div style="display: inline-flex">
					<span class="like"><svg class="a3" aria-hidden="true"
							focusable="false" data-prefix="far" data-icon="heart"
							class="svg-inline--fa fa-heart fa-w-16" role="img"
				...
				<div>
					<span><svg class="a3" aria-hidden="true" focusable="false"
							data-prefix="far" data-icon="comment-alt"
							class="svg-inline--fa fa-comment-alt fa-w-16" role="img"
							xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
							<path fill="currentColor"
								d="M448 0H64C28.7 0 0 28.7 0 64v288c0 35.3 28.7 64 64 64h96v84c0 7.1 5.8 12 12 12 2.4 0 4.9-.7 7.1-2.4L304 416h144c35.3 0 64-28.7 64-64V64c0-35.3-28.7-64-64-64zm16 352c0 8.8-7.2 16-16 16H288l-12.8 9.6L208 428v-60H64c-8.8 0-16-7.2-16-16V64c0-8.8 7.2-16 16-16h384c8.8 0 16 7.2 16 16v288z"></path></svg></span>
				</div>
			</div>
