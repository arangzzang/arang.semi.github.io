...
<footer class="footer">
	...
	<div class="footer_insta white">
		...
		<div class="instaimgs white">
			<div class="instaimg">
				<img src="<%=request.getContextPath()%>/image/img1.jpg" width="200"
					height="200">
			</div>
			<div class="instaimg">
				<img src="<%=request.getContextPath()%>/image/img2.jpg" width="200"
					height="200">
			</div>
			<div class="instaimg">
				<img src="<%=request.getContextPath()%>/image/img3.jpg" width="200"
					height="200">
			</div>
			<div class="instaimg">
				<img src="<%=request.getContextPath()%>/image/img4.jpg" width="200"
					height="200">
			</div>
		</div>
 --%>
...
.instatext {	color: grey;	font-size: 13px;	margin: 30px;}
.instaimg {	margin: 20px;	margin-top: 0px;	margin-bottom: 100px;}
.instaimgs {	display: flex;	justify-content: center;	background-color: #EEEEEE;}
.spacebox {	height: 140px;	background-color: white;}
.footer_insta {	height: 500px;	text-align: center;	/* border: red solid 1px; */	background-color: #EEEEEE;}
.footer_info {	background-color: rgb(233, 233, 233);    border: rgb(233, 233, 233) solid 1px;    width: 100%;    margin: 0 auto;    min-width: 700px;}
.infotext {	margin-left: 200px;	margin-right: 200px;}
.footer_logo {	margin-top: 30px;	margin-bottom: 10px;	/* padding-left : 200px;  */	text-align: center;	font-size: 20px;}
.footer_body {	margin-top: 20px;	/* margin-bottom: 200px; */}
.footer_body_ensalade>p {	margin: 10px;	text-align: center;	font-size:14px;	font: lightgrey;}
.footer_menu a {	color: black;	justify-content: space-around;	text-decoration: none;	text-align: left;	font-size: 12px;	font: lightgrey;}
.footer_menu a:hover {	color: green;}
.cs_time {	/* padding-left : 200px; */	margin-top: 20px;}
.cs_time>p {	margin: 10px;	text-align: center;	font-size: 13px;	font: lightgrey;}
